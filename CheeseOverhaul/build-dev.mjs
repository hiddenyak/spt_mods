...
const sptModsFolder = "C:/Games/SPT/3.10.5/user/mods/zzz-cheese-overhaul";
...
async function main() {
	...
	try {
		...
		await copyFiles(currentDir, sptModsFolder, buildIgnorePatterns);
		...
		logger.log(
			"success",
			"Your mod package has been created in the spt mods directory:"
		);
		logger.log(
			"success",
			`/${path.relative(
